...
// NewMockProgress creates a new instance of MockProgress. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockProgress(t testing.TB) *MockProgress {
	mock := &MockProgress{}
	mock.Mock.Test(t)
