...
// NewMockEC2Repository creates a new instance of MockEC2Repository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockEC2Repository(t testing.TB) *MockEC2Repository {
