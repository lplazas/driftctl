...
// NewMockApiGatewayV2Repository creates a new instance of MockApiGatewayV2Repository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockApiGatewayV2Repository(t testing.TB) *MockApiGatewayV2Repository {
