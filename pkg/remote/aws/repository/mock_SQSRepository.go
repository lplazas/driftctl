...
// NewMockSQSRepository creates a new instance of MockSQSRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockSQSRepository(t testing.TB) *MockSQSRepository {
