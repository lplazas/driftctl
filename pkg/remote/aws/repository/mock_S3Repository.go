...
// NewMockS3Repository creates a new instance of MockS3Repository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockS3Repository(t testing.TB) *MockS3Repository {
