...
// NewMockLambdaRepository creates a new instance of MockLambdaRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockLambdaRepository(t testing.TB) *MockLambdaRepository {
