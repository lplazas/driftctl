...
// NewMockAppAutoScalingRepository creates a new instance of MockAppAutoScalingRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockAppAutoScalingRepository(t testing.TB) *MockAppAutoScalingRepository {
