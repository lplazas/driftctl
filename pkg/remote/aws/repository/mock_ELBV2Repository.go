...
// NewMockELBV2Repository creates a new instance of MockELBV2Repository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockELBV2Repository(t testing.TB) *MockELBV2Repository {
