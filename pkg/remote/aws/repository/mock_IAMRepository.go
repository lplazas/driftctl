...
// NewMockIAMRepository creates a new instance of MockIAMRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockIAMRepository(t testing.TB) *MockIAMRepository {
