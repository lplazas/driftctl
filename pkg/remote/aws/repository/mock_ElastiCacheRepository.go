...
// NewMockElastiCacheRepository creates a new instance of MockElastiCacheRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockElastiCacheRepository(t testing.TB) *MockElastiCacheRepository {
