...
// NewMockApiGatewayRepository creates a new instance of MockApiGatewayRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockApiGatewayRepository(t testing.TB) *MockApiGatewayRepository {
