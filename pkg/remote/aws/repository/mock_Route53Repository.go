...
// NewMockRoute53Repository creates a new instance of MockRoute53Repository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockRoute53Repository(t testing.TB) *MockRoute53Repository {
