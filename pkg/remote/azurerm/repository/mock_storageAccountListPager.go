...
// newMockStorageAccountListPager creates a new instance of mockStorageAccountListPager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockStorageAccountListPager(t testing.TB) *mockStorageAccountListPager {
