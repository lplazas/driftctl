...
// NewMockStorageRespository creates a new instance of MockStorageRespository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockStorageRespository(t testing.TB) *MockStorageRespository {
