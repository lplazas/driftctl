...
// NewMockNetworkRepository creates a new instance of MockNetworkRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockNetworkRepository(t testing.TB) *MockNetworkRepository {
