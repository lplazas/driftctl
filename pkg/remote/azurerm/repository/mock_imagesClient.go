...
// newMockImagesClient creates a new instance of mockImagesClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockImagesClient(t testing.TB) *mockImagesClient {
