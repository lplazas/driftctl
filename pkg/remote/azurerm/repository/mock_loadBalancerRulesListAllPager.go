...
// newMockLoadBalancerRulesListAllPager creates a new instance of mockLoadBalancerRulesListAllPager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockLoadBalancerRulesListAllPager(t testing.TB) *mockLoadBalancerRulesListAllPager {
