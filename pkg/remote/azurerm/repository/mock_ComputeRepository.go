...
// NewMockComputeRepository creates a new instance of MockComputeRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockComputeRepository(t testing.TB) *MockComputeRepository {
