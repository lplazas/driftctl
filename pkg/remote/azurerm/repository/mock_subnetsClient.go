...
// newMockSubnetsClient creates a new instance of mockSubnetsClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockSubnetsClient(t testing.TB) *mockSubnetsClient {
