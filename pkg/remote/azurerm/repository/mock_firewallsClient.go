...
// newMockFirewallsClient creates a new instance of mockFirewallsClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockFirewallsClient(t testing.TB) *mockFirewallsClient {
