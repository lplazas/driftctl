...
// newMockLoadBalancersListAllPager creates a new instance of mockLoadBalancersListAllPager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockLoadBalancersListAllPager(t testing.TB) *mockLoadBalancersListAllPager {
