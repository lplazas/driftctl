...
// newMockVirtualNetworksListAllPager creates a new instance of mockVirtualNetworksListAllPager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockVirtualNetworksListAllPager(t testing.TB) *mockVirtualNetworksListAllPager {
