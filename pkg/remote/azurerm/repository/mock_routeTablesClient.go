...
// newMockRouteTablesClient creates a new instance of mockRouteTablesClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockRouteTablesClient(t testing.TB) *mockRouteTablesClient {
