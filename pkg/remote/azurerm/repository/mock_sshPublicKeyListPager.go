...
// newMockSshPublicKeyListPager creates a new instance of mockSshPublicKeyListPager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockSshPublicKeyListPager(t testing.TB) *mockSshPublicKeyListPager {
