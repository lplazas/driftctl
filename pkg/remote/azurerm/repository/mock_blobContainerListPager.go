...
// newMockBlobContainerListPager creates a new instance of mockBlobContainerListPager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockBlobContainerListPager(t testing.TB) *mockBlobContainerListPager {
