...
// newMockPublicIPAddressesListAllPager creates a new instance of mockPublicIPAddressesListAllPager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockPublicIPAddressesListAllPager(t testing.TB) *mockPublicIPAddressesListAllPager {
