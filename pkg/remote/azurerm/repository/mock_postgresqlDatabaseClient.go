...
// newMockPostgresqlDatabaseClient creates a new instance of mockPostgresqlDatabaseClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockPostgresqlDatabaseClient(t testing.TB) *mockPostgresqlDatabaseClient {
