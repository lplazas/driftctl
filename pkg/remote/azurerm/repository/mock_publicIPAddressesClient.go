...
// newMockPublicIPAddressesClient creates a new instance of mockPublicIPAddressesClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockPublicIPAddressesClient(t testing.TB) *mockPublicIPAddressesClient {
