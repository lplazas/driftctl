...
// newMockRegistryClient creates a new instance of mockRegistryClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockRegistryClient(t testing.TB) *mockRegistryClient {
