...
// newMockPrivateDNSZoneListPager creates a new instance of mockPrivateDNSZoneListPager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockPrivateDNSZoneListPager(t testing.TB) *mockPrivateDNSZoneListPager {
