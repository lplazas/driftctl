...
// newMockNetworkSecurityGroupsListAllPager creates a new instance of mockNetworkSecurityGroupsListAllPager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockNetworkSecurityGroupsListAllPager(t testing.TB) *mockNetworkSecurityGroupsListAllPager {
