...
// newMockRouteTablesListAllPager creates a new instance of mockRouteTablesListAllPager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockRouteTablesListAllPager(t testing.TB) *mockRouteTablesListAllPager {
