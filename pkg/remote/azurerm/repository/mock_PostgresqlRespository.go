...
// NewMockPostgresqlRespository creates a new instance of MockPostgresqlRespository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockPostgresqlRespository(t testing.TB) *MockPostgresqlRespository {
