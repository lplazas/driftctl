...
// newMockPrivateDNSRecordSetListPager creates a new instance of mockPrivateDNSRecordSetListPager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockPrivateDNSRecordSetListPager(t testing.TB) *mockPrivateDNSRecordSetListPager {
