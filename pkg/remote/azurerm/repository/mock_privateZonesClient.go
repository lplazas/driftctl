...
// newMockPrivateZonesClient creates a new instance of mockPrivateZonesClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockPrivateZonesClient(t testing.TB) *mockPrivateZonesClient {
