...
// NewMockPrivateDNSRepository creates a new instance of MockPrivateDNSRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockPrivateDNSRepository(t testing.TB) *MockPrivateDNSRepository {
