...
// newMockLoadBalancersClient creates a new instance of mockLoadBalancersClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockLoadBalancersClient(t testing.TB) *mockLoadBalancersClient {
