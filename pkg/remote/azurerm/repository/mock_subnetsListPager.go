...
// newMockSubnetsListPager creates a new instance of mockSubnetsListPager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockSubnetsListPager(t testing.TB) *mockSubnetsListPager {
