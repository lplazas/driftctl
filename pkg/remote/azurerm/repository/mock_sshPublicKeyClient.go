...
// newMockSshPublicKeyClient creates a new instance of mockSshPublicKeyClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockSshPublicKeyClient(t testing.TB) *mockSshPublicKeyClient {
