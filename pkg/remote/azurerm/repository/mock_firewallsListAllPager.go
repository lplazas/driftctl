...
// newMockFirewallsListAllPager creates a new instance of mockFirewallsListAllPager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockFirewallsListAllPager(t testing.TB) *mockFirewallsListAllPager {
