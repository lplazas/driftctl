...
// NewMockAssetRepository creates a new instance of MockAssetRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockAssetRepository(t testing.TB) *MockAssetRepository {
