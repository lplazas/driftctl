...
// NewMockDetailsFetcher creates a new instance of MockDetailsFetcher. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockDetailsFetcher(t testing.TB) *MockDetailsFetcher {
	mock := &MockDetailsFetcher{}
	mock.Mock.Test(t)
