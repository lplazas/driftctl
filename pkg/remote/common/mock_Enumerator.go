...
// NewMockEnumerator creates a new instance of MockEnumerator. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockEnumerator(t testing.TB) *MockEnumerator {
	mock := &MockEnumerator{}
	mock.Mock.Test(t)
