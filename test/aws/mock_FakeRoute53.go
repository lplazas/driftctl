...
// NewMockFakeRoute53 creates a new instance of MockFakeRoute53. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeRoute53(t testing.TB) *MockFakeRoute53 {
