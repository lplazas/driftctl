...
// NewMockFakeELBV2 creates a new instance of MockFakeELBV2. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeELBV2(t testing.TB) *MockFakeELBV2 {
	mock := &MockFakeELBV2{}
	mock.Mock.Test(t)
