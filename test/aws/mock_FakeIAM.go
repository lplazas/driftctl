...
// NewMockFakeIAM creates a new instance of MockFakeIAM. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeIAM(t testing.TB) *MockFakeIAM {
	mock := &MockFakeIAM{}
	mock.Mock.Test(t)
