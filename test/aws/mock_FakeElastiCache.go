...
// NewMockFakeElastiCache creates a new instance of MockFakeElastiCache. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeElastiCache(t testing.TB) *MockFakeElastiCache {
