...
// NewMockFakeCloudformation creates a new instance of MockFakeCloudformation. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeCloudformation(t testing.TB) *MockFakeCloudformation {
