...
// NewMockFakeAutoscaling creates a new instance of MockFakeAutoscaling. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeAutoscaling(t testing.TB) *MockFakeAutoscaling {
