...
// NewMockFakeApiGatewayV2 creates a new instance of MockFakeApiGatewayV2. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeApiGatewayV2(t testing.TB) *MockFakeApiGatewayV2 {
