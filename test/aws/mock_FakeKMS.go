...
// NewMockFakeKMS creates a new instance of MockFakeKMS. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeKMS(t testing.TB) *MockFakeKMS {
	mock := &MockFakeKMS{}
	mock.Mock.Test(t)
