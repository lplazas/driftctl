...
// NewMockFakeLambda creates a new instance of MockFakeLambda. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeLambda(t testing.TB) *MockFakeLambda {
	mock := &MockFakeLambda{}
	mock.Mock.Test(t)
