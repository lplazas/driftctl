...
// NewMockFakeDynamoDB creates a new instance of MockFakeDynamoDB. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeDynamoDB(t testing.TB) *MockFakeDynamoDB {
