...
// NewMockFakeECR creates a new instance of MockFakeECR. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeECR(t testing.TB) *MockFakeECR {
	mock := &MockFakeECR{}
	mock.Mock.Test(t)
