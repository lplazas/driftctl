...
// NewMockFakeRDS creates a new instance of MockFakeRDS. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeRDS(t testing.TB) *MockFakeRDS {
	mock := &MockFakeRDS{}
	mock.Mock.Test(t)
