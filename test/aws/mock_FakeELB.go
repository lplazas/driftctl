...
// NewMockFakeELB creates a new instance of MockFakeELB. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeELB(t testing.TB) *MockFakeELB {
	mock := &MockFakeELB{}
	mock.Mock.Test(t)
