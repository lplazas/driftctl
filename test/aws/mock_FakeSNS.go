...
// NewMockFakeSNS creates a new instance of MockFakeSNS. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeSNS(t testing.TB) *MockFakeSNS {
	mock := &MockFakeSNS{}
	mock.Mock.Test(t)
