...
// NewMockFakeApplicationAutoScaling creates a new instance of MockFakeApplicationAutoScaling. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeApplicationAutoScaling(t testing.TB) *MockFakeApplicationAutoScaling {
