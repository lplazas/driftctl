...
// NewMockFakeCloudFront creates a new instance of MockFakeCloudFront. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeCloudFront(t testing.TB) *MockFakeCloudFront {
