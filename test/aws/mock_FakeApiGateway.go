...
// NewMockFakeApiGateway creates a new instance of MockFakeApiGateway. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeApiGateway(t testing.TB) *MockFakeApiGateway {
