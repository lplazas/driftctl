...
// NewMockFakeS3 creates a new instance of MockFakeS3. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockFakeS3(t testing.TB) *MockFakeS3 {
	mock := &MockFakeS3{}
	mock.Mock.Test(t)
